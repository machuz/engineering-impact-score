...
func TestCalcSurvivalFull_PressureAndCoverage(t *testing.T) {
	...
	// ChangePressure is keyed by ModuleResolver.ModuleOf(). For these
	// 2-component dirs (e.g. "high/covered") the convention-aware resolver
	// returns the dir unchanged, so the keys line up with the blame paths.
