...
**Y.Y.から十分良い設計を引き継ぎ、それをさらに良くできたからこそ、Architectとしてこのスコアに乗ることができている。**
...
P.とは昔一緒に働いたことがある。その時に設計知識の合流をした。だからお互いの設計について共通知が取れている。今回のスコアがどうであれ、馬力があることは知っている。**うちのチームで80台を叩き出せる力があることも知っている。**
