---
title: "git考古学 #3 —— Architectには流派がある：Git履歴が暴く進化の分岐モデル"
emoji: "🔀"
type: "tech"
...
![R.M.rchetypes](https://raw.githubusercontent.com/machuz/engineering-impact-score/main/docs/images/blog/ch3-engineer-profiles.svg)
...
Anchorは品質を守る側を示す。Massは精度が悪いことを示す。今のH.の**苦しみと頑張りが数字に出ている**。
...
**これがO.の苦しみを一番示している指標だ。** 触られた重力場で、置き換えられている割合が多いことを示している。
...
H.の「死ぬほど生産して、でも11%しか残らない。それでも生産し続けている」——これは苦しみだ。でも同時に、頑張りでもある。その両方が、数字に出ている。

O.の「重力を出せる。でもまだ置き換えられている。でも全く残ってないわけじゃない」——これも苦しみだ。でもちゃんと残っている。感覚では感じられないそれを、指標は拾う。
...
![O.のGravity計算](https://raw.githubusercontent.com/machuz/engineering-impact-score/main/docs/images/blog/ch3-gravity-calc-d.svg)

Gravity 68の**大部分はIndispensability（1人占有）とBreadth（広さ）**から来ている。Design = 5 なので「構造の中心」というより「広く1人で持っている」。

一方、R.M.の場合：

![R.M.のGravity計算](https://raw.githubusercontent.com/machuz/engineering-impact-score/main/docs/images/blog/ch3-gravity-calc-a.svg)
...
![O.のパターン](https://raw.githubusercontent.com/machuz/engineering-impact-score/main/docs/images/blog/ch3-data-pattern.svg)
...
![H.のパターン](https://raw.githubusercontent.com/machuz/engineering-impact-score/main/docs/images/blog/ch3-data-anchor-mass.svg)
