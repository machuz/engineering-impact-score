...
ここには「正規化の罠」がある。EISの相対正規化では、チーム内の最高貢献者が100になる。つまり、あるリポジトリのトップスコアは、別のリポジトリでは平凡なスコアかもしれない。しかし今回の話はそれよりもっと根本的だ。正規化の問題は計算の話だが、Engineering Relativityは**構造の話**だ。
