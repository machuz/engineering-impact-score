...
1. **In the last week, did you initiate any movement that wasn't asked of you by anyone?**
...
3. **Is that attachment pointing outward (success, evaluation, status) or inward (principle, operating state, heat itself)?**
   Outward-facing → purity is eroding in that direction.
4. **Compared with who you were six months ago, has the direction of your heat shifted?**
...
9. **Does the organization have enclosures (controlled chaos) that permit moves outside the script?**
...
If this series resonated, the Japanese original book is [here on OrbitLens Library](https://library.orbitlens.io/psychological-os/). The sister work (Structure-Driven Engineering Organization Theory) and the tool that started it all ([EIS — Engineering Impact Signal](https://github.com/machuz/eis)) are linked from there.
