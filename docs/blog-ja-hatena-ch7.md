...
![Cover](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/cover-ch7.png)
...
Chart.jsベースの折れ線グラフで、個人・チームのImpact推移、Health指標、メンバーシップ構成、Classification変遷が一覧できる。ツールチップにはRole/Style/State/Confidenceが表示され、Transitionマーカーが変化のタイミングを示す。
...
![Team Classification](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch7-team-classification.svg)
...
この四つが揃ったとき、チームのClassificationは **Spiral / Architectural Engine / Builder / Mature / Healthy** になる。
...
- **Classification: Spiral / Architectural Engine / Mature** ——「うちのチームは設計力が分散していて、特定個人に依存しない構造です」
...
候補者に対して「技術的に面白いチームです」と口で言うのではなく、**グラフを見せる**。Impact推移を見せる。チームがどう進化してきたかをデータで語る。
...
← [第6章：チームは進化する](https://ma2k8.hateblo.jp/entry/2026/03/14/184223) | [第8章：Engineering Relativity →](https://ma2k8.hateblo.jp/entry/2026/03/14/233602)
