...
## 7. ベクトルが合っているとき —— 外圧が熱になる瞬間

純度は、燃料の出どころだけで決まらない。**同じ外圧でも、受け取る側で何に変換されるかで純度は変わる**。

私はこれを **ベクトルが合っている状態** と呼んでいる。

個人には向きがある。プロダクトの理念、仲間との関係、自分が進みたい探索の方向。外圧にも向きがある。依頼、締切、要件、ルーティン。**二つの向きが一致しているとき、外圧は摩擦ではなく推進力になる**。

向きが合っているとき、外圧は **納得** という変換機を通って内圧になる。典型的な経路が二つある。

**理念経由** —— プロダクトや事業の理念に共感していると、日々の雑多なルーティンワークも「理念を実装する行為」として納得に変換できる。書類仕事も、会議調整も、泥臭いデバッグも、方向が合っていれば内圧に繋がる。

**信頼経由** —— チームや仲間との絆を軸に動いていると、頼まれ仕事を「信頼の履行」として納得に変換できる。依頼そのものに熱がなくても、依頼してきた人との関係が熱を持っていれば、その熱が仕事に乗り移る。

この二経路を持つ人は、外圧を避けなくていい。外圧がそのまま燃料に変換される。逆に、この経路を持たない人は、どれだけ外圧が正当でも熱にならない。ベクトルが合っていない外圧は、**純度を削る方向にしか働かない**。

だから強い心理OSは、外圧そのものを避けようとしない。**外圧を納得に変換する経路 —— 理念への共感、仲間への信頼 —— を持っているかどうか** を気にしている。

ベクトルが合わない場所で動き続けることは、最も純度を下げる行為だ。逆に、ベクトルが合っている場所では、同じ外圧が熱を増やす。この差が、心理OSの持続可能性を決める。
