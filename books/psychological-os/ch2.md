...
> ただ……やる事……その熱、行為そのもの、生きってこと……実ってヤツだ……！
...
> それは飾りだと……成功とか失敗とか人の目とか……そういうことから覚れろと
...
![主役は俺、命は俺が運ぶ者](./images/ch2-section-3-protagonist.png)

普通、人は「命が自分を生かしている」と感じる。命に生かされ、命の要請に応じて動く。これは受動態の生だ。

アカギはそれを反転させる。**自分が命を運ぶ**。自分を全うするために命を使う。命に従うのではなく、命を乗り物として駆動する。これが agency の極限だ。
...
> 天才とかいわれる連中の運中の正体は……みな、その類の異常な持続力を発揮している
...
これは傲慢ではない。構造的な分断だ。強い心理OSは強い心理OSを呼び、弱い心理OSは弱い心理OSを呼ぶ。この分離は、**組織を運営する上で深刻な問題になる**(この論点は ch3 で扱う)。
...
これは個人の内側の話だ。だが、個人の心理OSは孤立して存在しない。集団の中で伝染したり、反射したり、抑圧されたりする。強い心理OSを持つ個人が組織に入ったとき、何が起こるか。**心理OSが組織と接続されるとき、そこに何が生まれ、何が壊れるか**。

次章では、この接続面を扱う。外側の物理(構造駆動)と内側の原理(心理OS)が噛み合う条件を、アカギの哲学の射程を保ったまま覗きに行く。
