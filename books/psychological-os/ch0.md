...
『git考古学』では、エンジニアの外側のシグナル —— コミット履歴・生存率・設計への貢献 —— を git 履歴だけから観測した。『構造駆動エンジニアリング組織論』では、組織を連続場の物理として記述した。どちらも、外側から見える像の話だ。

だが、その構造の中で動いている人間の内側には、外側から観測できない別の作動原理が走っている。同じコードを書き続けるエンジニアが、ある日から動かなくなる。同じ組織にいながら、ある人は熱を保ち、ある人は失っていく。この差は、観測器では届かない層で決まっている。

本書はその層を扱う。個人と組織の**内側の作動状態**を、アカギ『天』最終盤の哲学を下敷きに、「心理OS」と呼んで記述する。構造駆動が外側の物理を担うのに対し、本書は内側の原理を扱う姉妹編である。
