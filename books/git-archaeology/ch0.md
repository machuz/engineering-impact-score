...
1. **[履歴だけでエンジニアの「戦闘力」を定量化する](ch1)** — 7軸スコアリングの全設計
2. **[チームトポロジー](ch2)** — スコアからチーム構造が見える
3. **[FE Architectは分岐する](ch3)** — フロントエンドの進化モデル
4. **[BE Architectは収束する](ch4)** — バックエンドの進化モデル
5. **[Infraは沈黙する](ch5)** — インフラエンジニアの可視化問題
6. **[Gravity Map](ch6)** — コードの重力場を可視化する
7. **[リスク検出](ch7)** — 技術的リスクの定量化
8. **[正規化の設計](ch8)** — なぜハイブリッドスコアリングか
9. **[ドメイン分離](ch9)** — BE/FE/Infraを混ぜると汚染される
10. **[時間減衰の設計](ch10)** — Survivalの数学
11. **[アーキタイプの設計](ch11)** — 分類ロジックの全貌
12. **[チーム指標](ch12)** — チームの健康診断
13. **[Robust Survival](ch13)** — テスト済みコードの生存
14. **[変更圧](ch14)** — change pressureの定量化
15. **[複数リポ分析](ch15)** — 組織横断のスコアリング
16. **[未来](ch16)** — EISの次
