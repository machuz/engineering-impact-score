...
![Cover](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/hatena/cover-ch6.png)
...
- **Character** — チームの性格（Spiral, Dwarf, Cluster, Lenticular, Filament, Collision）
...
![Backend Team Timeline](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-backend-team-timeline.svg)
...
- **2026-H1**: チームが Spiral / Architectural Engine / Mature / Healthy に
...
![Backend Scores](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-backend-scores.svg)

Design 36.4はまだ低い。Architectがmachuz一人に集中しているためだ。他のメンバーのDesignシグナルはほとんど0〜30台。

**Spiralチームの次の課題は、Design力の分散だ。**
...
![Frontend Team Timeline](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-frontend-team-timeline.svg)
...
**2025-H1にCluster / Delivery Teamに変わり、2025-H2に戻っている。**

この一時的な変化は何か。2025-H1はR.M.が Architect としてImpact 83.8を記録した時期だ。設計だけでなく生産量も高く、一人で設計と実装の両方を高回転で回していた。同時期にO.も Anchor（54.3）として安定した配信を続けていた。つまり**設計者が高回転で生産も兼ね、Anchorが着実に配信する**構成。結果、チームは一時的にCluster（大量生産型）/ Delivery Team（配信チーム）の特性を見せた。

しかしその「最大出力」は一時的だった。翌半期にはDwarf / Maintenanceに戻る。
...
![Infra & Firmware](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-infra-firmware.svg)

InfraはFilament / Exploration / Emerging。**まだ形を成していないチーム**だ。

メンバーのImpactを見ると、全員がGrowingまたはSpread。Architectが一人もいない。Design Vacuum は必然だ。

しかしPhaseがEmergingであることは、**成長過程にある**ことを意味する。Decliningではない。

### Firmware：Firefighting

Firmwareは2人しかいない。Character: Collision、Culture: Firefighting。

Production 100, Quality 84.6。**生産力はある。しかし設計がない。**

これは「今ある問題に対処し続けている」チームだ。構造を作る余裕がない。Architectが不在で、Design 0。

**小規模チームほど、一人の参入・離脱がチームの性質を根本から変える。** Firmwareにもし一人のArchitectが加わったら、Collision → Builder に変わるだろう。
...
![machuz Timeline](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-machuz-timeline.svg)
...
![Architect到達](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-architect-quarter.svg)
...
![BE Architects](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-be-architects.svg)
...
![FE Architects](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-fe-architects.svg)

FEでは、R.M.が Architect になった時点でO.は Anchor に降りている。**一見、BEと同じ「一人」パターンに見える。**

しかし3ヶ月刻みのデータ（第5章）では：

![同時Architect](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-simultaneous.svg)
...
![O.遷移](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-engineer-j-transitions.svg)
...
![成長ポテンシャル](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-health.svg)
...
![X.](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-engineer-k.svg)
...
![Gravity Transfer](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-gravity-transfer.svg)
...
![Evolution Paths](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-evolution-paths.svg)
...
**Builder文化が不在のチームは、成熟の方向に進みにくい。** 守りだけでは衰退する。
...
Backendの2024-H2を見る。machuzがAnchor Builder（Impact 76.4）、Y.Y.が Architect Builder（Impact 84.1）。しかしProducerが一人もいない。

この時期のチームClassification：

![Producer不在](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-producer-vacuum.svg)
...
![有効メンバー](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-effective-members.svg)

machuz（Architect Builder）に加え、複数のAnchor/Producerが存在する。構造の上で生産する人がいる。だからSpiral / Architectural Engine になれた。
...
![machuzの軌跡](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-data-machuz-phases.svg)
...
![Evolution Model](https://raw.githubusercontent.com/machuz/eis/main/docs/images/blog/ch6-evolution-model.svg)
